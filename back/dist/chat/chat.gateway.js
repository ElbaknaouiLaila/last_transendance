...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`1940225334_56_4_56_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`1940225334_58_5_58_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`1940225334_69_4_69_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`1940225334_71_5_71_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`1940225334_83_4_83_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`1940225334_87_4_87_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`1940225334_91_4_91_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`1940225334_133_6_133_57_4`, "*************   handling_joinRoom_dm"));
        const result = await this.ChatService.cheakBlockedUser(senderId, receiverId);
        if (result) {
            console.log(...oo_oo(`1940225334_138_10_138_56_4`, "u are blocked from the reciever"));
        }
        else {
            this.joinRoom(senderClient, room);
            this.joinRoom(receiverClient, room);
            console.log(...oo_oo(`1940225334_146_8_146_39_4`, "starting sending"));
            console.log(...oo_oo(`1940225334_148_8_148_29_4`, senderId));
            console.log(...oo_oo(`1940225334_149_8_149_31_4`, receiverId));
            const dm = await this.ChatService.checkDm(senderId, receiverId);
            console.log(...oo_oo(`1940225334_155_8_155_56_4`, `FROM gatways value of Dm is ${dm}`));
            console.log(...oo_oo(`1940225334_157_8_157_74_4`, `^^^  SENDER IS ${senderId} REciver is ${receiverId}`));
            ...
            console.log(...oo_oo(`1940225334_172_8_172_73_4`, `¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤`));
            this.server.to(room).emit('chatToDm', data);
            console.log(...oo_oo(`1940225334_174_8_174_36_4`, "after sending"));
        }
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`1940225334_189_4_189_49_4`, "*************   direct_message"));
    ...
    async handling_joinRoom_group(data, users) {
        console.log(...oo_oo(`1940225334_213_4_213_58_4`, "*************   handling_joinRoom_group"));
        const room = `room_${data.id}`;
        for (const user of users) {
            console.log(...oo_oo(`1940225334_220_6_220_45_4`, "Inside sockets of groups"));
            const client = this.connectedClients.get(user.userId);
            console.log(...oo_oo(`1940225334_222_6_222_53_4`, "11111111111111111111111111111111"));
            this.joinRoom(client, room);
            console.log(...oo_oo(`1940225334_224_6_224_59_4`, "22222222222222222222222222222222222222"));
        }
        ...
        if (checkmutedUser) {
            if (checkmutedUser.muted == false) {
                ...
                console.log(...oo_oo(`1940225334_241_8_241_47_4`, "befoor emiting in groups"));
                this.server.to(room).emit('chatToGroup', result);
                console.log(...oo_oo(`1940225334_243_8_243_40_4`, "ENDING JOINGROUP "));
            }
        }
    }
    async sendInChannel(client, data) {
        console.log(...oo_oo(`1940225334_266_4_266_64_4`, "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"));
        console.log(...oo_oo(`1940225334_267_4_267_50_4`, "*************   channel_message"));
        const channel = await this.ChatService.findChannel(data.to);
        if (channel) {
            const users = await this.ChatService.getUsersInChannel(data.to);
            console.log(...oo_oo(`1940225334_275_6_275_66_4`, "########################################## 00"));
            console.log(...oo_oo(`1940225334_276_6_276_24_4`, users));
            this.handling_joinRoom_group(data, users);
        }
        return "OK";
    }
    async allConversationsDm(client, data) {
        console.log(...oo_oo(`1940225334_291_4_291_53_4`, "*************   allConversationsDm"));
        ...
        console.log(...oo_oo(`1940225334_301_4_301_79_4`, `##################################### DMS of ${user.id_user}`));
        console.log(...oo_oo(`1940225334_302_4_302_20_4`, dms));
        let recv;
        let send;
        let namerecv;
        let avatarrecv;
        ...
        if (dms) {
            ...
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`1940225334_322_8_322_28_4`, lastMsg));
                recv = dmm.receiverId;
                send = dmm.senderId;
            ...
            console.log(...oo_oo(`1940225334_357_6_357_73_4`, "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ"));
            console.log(...oo_oo(`1940225334_358_6_358_29_4`, arrayOfDms));
            client.emit('response', arrayOfDms);
        }
    }
    async getAllMessages(client, data) {
        console.log(...oo_oo(`1940225334_376_4_376_48_4`, "*************   allMessagesDm"));
        const userId = Number(client.handshake.query.user_id);
        const user = await this.UsersService.findById(userId);
        console.log(...oo_oo(`1940225334_381_4_381_21_4`, data));
        if (user) {
            ...
            if (existDm) {
                ...
                console.log(...oo_oo(`1940225334_395_8_395_29_4`, messages));
                client.emit('historyDms', messages);
            }
        }
        else
            console.log(...oo_oo(`1940225334_404_6_404_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        console.log(...oo_oo(`1940225334_414_4_414_57_4`, "********************** allMessagesRoom"));
        console.log(...oo_oo(`1940225334_416_4_416_21_4`, data));
        ...
        if (user) {
            ...
            console.log(...oo_oo(`1940225334_433_6_433_46_4`, "Error user does not exist"));
    }
    async leavingRoom(client, data) {
        console.log(...oo_oo(`1940225334_441_4_441_54_4`, "********************** leaveChannel"));
        console.log(...oo_oo(`1940225334_443_4_443_21_4`, data));
        const user = await this.UsersService.findById(data.user_id);
        if (user) {
            const leave = await this.ChatService.getLeavingRoom(data.id, data.user_id);
            if (leave) {
                console.log(...oo_oo(`1940225334_451_8_451_83_4`, "User with ${data.user_id} is leaving room with id ${data.id}"));
                return true;
            }
        }
        else
            console.log(...oo_oo(`1940225334_456_6_456_46_4`, "Error user does not exist"));
    }
    async bannedUser(client, data) {
        console.log(...oo_oo(`1940225334_462_2_462_27_4`, "bannedUser"));
        console.log(...oo_oo(`1940225334_463_2_463_19_4`, data));
        ...
        if (client) {
            ...
            console.log(...oo_oo(`1940225334_489_4_489_26_4`, "ERRROR "));
    }
    async kickUser(client, data) {
        console.log(...oo_oo(`1940225334_509_2_509_25_4`, "kickUser"));
        console.log(...oo_oo(`1940225334_510_2_510_19_4`, data));
        const user1 = await this.UsersService.findById(data.user_id);
        ...
        if (client) {
            ...
            console.log(...oo_oo(`1940225334_536_4_536_24_4`, "error"));
    }
    async muteUser(client, data) {
        console.log(...oo_oo(`1940225334_542_2_542_25_4`, "muteUser"));
        console.log(...oo_oo(`1940225334_543_2_543_19_4`, data));
        const user1 = await this.UsersService.findById(data.user_id);
        const user2 = await this.UsersService.findById(data.kickuser);
        if (client) {
            const id = Number(client.handshake.query.user_id);
            ...
            console.log(...oo_oo(`1940225334_569_4_569_24_4`, "error"));
    }
};
