...
let ChatService = class ChatService {
    ...
    async checkDm(idSend, idRecv) {
        ...
        if (dm1) {
            console.log(...oo_oo(`3690957866_49_12_49_44_4`, `FRom dm1 |${dm1}|`));
            return dm1;
        }
        ...
        if (dm2) {
            console.log(...oo_oo(`3690957866_63_12_63_44_4`, `FRom dm2 |${dm2}|`));
            return dm2;
        }
        ...
        console.log(...oo_oo(`3690957866_75_4_75_78_4`, "CHECK DM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   %%%%%%%%%%%%"));
        console.log(...oo_oo(`3690957866_76_4_76_38_4`, `Result is ${result}`));
        return (result);
    }
    ...
    async getAllConversations(id) {
        try {
            ...
            console.log(...oo_oo(`3690957866_124_12_124_67_4`, `!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  :: ${dms}`));
            return dms;
        }
        catch (error) {
    ...
    async getDm(idSend, idRecv) {
        try {
            ...
            if (dm1) {
                console.log(...oo_oo(`3690957866_148_16_148_47_4`, `get Dm1 |${dm1}|`));
                return dm1;
            }
            const dm2 = await this.prisma.dm.findUnique({
                where: {
            ...
            if (dm2) {
                console.log(...oo_oo(`3690957866_162_16_162_47_4`, `get dm2 |${dm2}|`));
                return dm2;
            }
        }
        catch (error) {
