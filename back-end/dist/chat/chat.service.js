...
let ChatService = class ChatService {
    ...
    async checkDm(idSend, idRecv) {
        ...
        if (dm1) {
            console.log(...oo_oo(`2837819233_51_12_51_44_4`, `FRom dm1 |${dm1}|`));
            return dm1;
        }
        ...
        if (dm2) {
            console.log(...oo_oo(`2837819233_65_12_65_44_4`, `FRom dm2 |${dm2}|`));
            return dm2;
        }
        ...
        console.log(...oo_oo(`2837819233_77_4_77_78_4`, "CHECK DM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   %%%%%%%%%%%%"));
        console.log(...oo_oo(`2837819233_78_4_78_38_4`, `Result is ${result}`));
        return (result);
    }
    ...
    async getAllConversations(id) {
        try {
            ...
            console.log(...oo_oo(`2837819233_126_12_126_67_4`, `!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  :: ${dms}`));
            return dms;
        }
        catch (error) {
    ...
    async getDm(idSend, idRecv) {
        try {
            ...
            if (dm1) {
                console.log(...oo_oo(`2837819233_150_16_150_47_4`, `get Dm1 |${dm1}|`));
                return dm1;
            }
            const dm2 = await this.prisma.dm.findUnique({
                where: {
            ...
            if (dm2) {
                console.log(...oo_oo(`2837819233_164_16_164_47_4`, `get dm2 |${dm2}|`));
                return dm2;
            }
        }
        catch (error) {
