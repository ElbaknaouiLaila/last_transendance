...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`1482154201_54_4_54_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`1482154201_56_6_56_49_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`1482154201_67_4_67_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`1482154201_69_6_69_49_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`1482154201_80_4_80_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`1482154201_84_4_84_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`1482154201_88_4_88_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`1482154201_129_4_129_55_4`, "*************   handling_joinRoom_dm"));
        this.joinRoom(senderClient, room);
        this.joinRoom(receiverClient, room);
        console.log(...oo_oo(`1482154201_135_4_135_35_4`, "starting sending"));
        const dm = await this.ChatService.checkDm(senderId, receiverId);
        console.log(...oo_oo(`1482154201_143_4_143_52_4`, `FROM gatways value of Dm is ${dm}`));
        ...
        console.log(...oo_oo(`1482154201_160_4_160_32_4`, "after sending"));
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`1482154201_176_4_176_49_4`, "*************   direct_message"));
        console.log(...oo_oo(`1482154201_179_4_179_21_4`, data));
    ...
    async handling_joinRoom_group(data, users) {
        console.log(...oo_oo(`1482154201_198_4_198_58_4`, "*************   handling_joinRoom_group"));
        const room = `room_${data.id}`;
        for (const user of users) {
            console.log(...oo_oo(`1482154201_205_6_205_45_4`, "Inside sockets of groups"));
            const client = this.connectedClients.get(user.userId);
            console.log(...oo_oo(`1482154201_207_6_207_53_4`, "11111111111111111111111111111111"));
            this.joinRoom(client, room);
            console.log(...oo_oo(`1482154201_209_6_209_59_4`, "22222222222222222222222222222222222222"));
        }
        ...
        console.log(...oo_oo(`1482154201_221_4_221_43_4`, "befoor emiting in groups"));
        console.log(...oo_oo(`1482154201_222_4_222_21_4`, save));
        this.server.to(room).emit('chatToGroup', result);
        console.log(...oo_oo(`1482154201_224_4_224_36_4`, "ENDING JOINGROUP "));
    }
    async sendInChannel(client, data) {
        console.log(...oo_oo(`1482154201_245_4_245_64_4`, "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"));
        console.log(...oo_oo(`1482154201_246_4_246_50_4`, "*************   channel_message"));
        console.log(...oo_oo(`1482154201_247_4_247_21_4`, data));
    ...
    async allConversationsDm(client, data) {
        console.log(...oo_oo(`1482154201_266_4_266_53_4`, "*************   allConversationsDm"));
        ...
        if (dms) {
            ...
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`1482154201_282_8_282_54_4`, `Last message is ${lastMsg.text}`));
                console.log(...oo_oo(`1482154201_283_8_283_30_4`, dmm.id_dm));
                const newDm = {
                    id_room: dmm.id_dm,
                    id: dmm.receiverId,
    ...
    async getAllMessages(client, data) {
        console.log(...oo_oo(`1482154201_315_4_315_48_4`, "*************   allMessagesDm"));
        console.log(...oo_oo(`1482154201_316_4_316_47_4`, client.handshake.query.user_id));
        console.log(...oo_oo(`1482154201_317_4_317_21_4`, data));
        const userId = Number(client.handshake.query.user_id);
        const user = await this.UsersService.findById(userId);
        if (user) {
            const messages = await this.ChatService.getAllMessages(data.room_id);
            const room = `room_${data.room_id}`;
            console.log(...oo_oo(`1482154201_324_6_324_27_4`, messages));
            client.emit('historyDms', messages);
        }
        else
            console.log(...oo_oo(`1482154201_331_6_331_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        console.log(...oo_oo(`1482154201_339_4_339_37_4`, "** allMessagesRoom"));
        console.log(...oo_oo(`1482154201_341_4_341_21_4`, data));
        console.log(...oo_oo(`1482154201_342_4_342_29_4`, data.user_id));
        ...
        if (user) {
            ...
            console.log(...oo_oo(`1482154201_349_6_349_27_4`, messages));
            client.emit('hostoryChannel', messages);
        }
        else
            console.log(...oo_oo(`1482154201_356_6_356_46_4`, "Error user does not exist"));
    }
};
