...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`1506120393_55_4_55_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`1506120393_57_5_57_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`1506120393_68_4_68_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`1506120393_70_5_70_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`1506120393_82_4_82_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`1506120393_86_4_86_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`1506120393_90_4_90_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`1506120393_135_6_135_37_4`, "starting sending"));
        const dm = await this.ChatService.checkDm(senderId, receiverId);
        console.log(...oo_oo(`1506120393_141_6_141_54_4`, `FROM gatways value of Dm is ${dm}`));
        ...
        console.log(...oo_oo(`1506120393_158_6_158_34_4`, "after sending"));
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`1506120393_176_4_176_21_4`, data));
        room = this.createRoom(data.from, data.to);
        this.handling_joinRoom_dm(room, data.from, data.to, data.message);
        console.log(...oo_oo(`1506120393_183_4_183_58_4`, `FRom websockets DM ==== ${data.message}`));
        console.log();
        console.log(...oo_oo(`1506120393_185_4_185_51_4`, `client connected is ${client.id}`));
        return 'Hello world!';
    }
    ...
    async allConversationsDm(client, data) {
        ...
        console.log(...oo_oo(`1506120393_255_4_255_53_4`, `Socket from allDms is ${client.id}`));
        const user = await this.UsersService.findById(userId);
        const dms = await this.ChatService.getAllConversations(user.id_user);
        console.log(...oo_oo(`1506120393_261_4_261_44_4`, "|||||||||||||||||||||||||"));
        if (dms) {
            const arrayOfDms = [];
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`1506120393_270_8_270_54_4`, `Last message is ${lastMsg.text}`));
                console.log(...oo_oo(`1506120393_271_8_271_30_4`, dmm.id_dm));
                const newDm = {
                    id_room: dmm.id_dm,
                    id: dmm.receiverId,
            ...
            console.log(...oo_oo(`1506120393_286_6_286_35_4`, "ZZZZZZZZZZZZZZ"));
            console.log(...oo_oo(`1506120393_287_6_287_29_4`, arrayOfDms));
            client.emit('response', arrayOfDms);
        }
        console.log(...oo_oo(`1506120393_297_4_297_34_4`, "after allconDms"));
    }
    async getAllMessages(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`1506120393_311_6_311_45_4`, `messages are ${messages}`));
            client.emit('historyDms', messages);
            console.log(...oo_oo(`1506120393_315_6_315_34_4`, "after sending"));
        }
        else
            console.log(...oo_oo(`1506120393_318_6_318_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`1506120393_336_6_336_34_4`, "after sending"));
        }
        else
            console.log(...oo_oo(`1506120393_339_6_339_46_4`, "Error user does not exist"));
    }
};
