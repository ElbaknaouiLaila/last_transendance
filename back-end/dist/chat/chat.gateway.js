...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`2894326370_55_4_55_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`2894326370_57_5_57_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`2894326370_68_4_68_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`2894326370_70_5_70_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`2894326370_82_4_82_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`2894326370_86_4_86_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`2894326370_90_4_90_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`2894326370_132_6_132_57_4`, "*************   handling_joinRoom_dm"));
        this.joinRoom(senderClient, room);
        this.joinRoom(receiverClient, room);
        console.log(...oo_oo(`2894326370_138_6_138_37_4`, "starting sending"));
        console.log(...oo_oo(`2894326370_140_6_140_27_4`, senderId));
        console.log(...oo_oo(`2894326370_141_6_141_29_4`, receiverId));
        const dm = await this.ChatService.checkDm(senderId, receiverId);
        console.log(...oo_oo(`2894326370_147_6_147_54_4`, `FROM gatways value of Dm is ${dm}`));
        ...
        console.log(...oo_oo(`2894326370_164_6_164_34_4`, "after sending"));
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`2894326370_181_4_181_49_4`, "*************   direct_message"));
    ...
    async handling_joinRoom_group(data, users) {
        console.log(...oo_oo(`2894326370_205_4_205_58_4`, "*************   handling_joinRoom_group"));
        const room = `room_${data.id}`;
        for (const user of users) {
            console.log(...oo_oo(`2894326370_212_6_212_45_4`, "Inside sockets of groups"));
            const client = this.connectedClients.get(user.userId);
            console.log(...oo_oo(`2894326370_214_6_214_53_4`, "11111111111111111111111111111111"));
            this.joinRoom(client, room);
            console.log(...oo_oo(`2894326370_216_6_216_59_4`, "22222222222222222222222222222222222222"));
        }
        ...
        console.log(...oo_oo(`2894326370_228_6_228_45_4`, "befoor emiting in groups"));
        this.server.to(room).emit('chatToGroup', result);
        console.log(...oo_oo(`2894326370_231_4_231_36_4`, "ENDING JOINGROUP "));
    }
    async sendInChannel(client, data) {
        console.log(...oo_oo(`2894326370_252_4_252_64_4`, "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"));
        console.log(...oo_oo(`2894326370_253_4_253_50_4`, "*************   channel_message"));
    ...
    async allConversationsDm(client, data) {
        console.log(...oo_oo(`2894326370_275_4_275_53_4`, "*************   allConversationsDm"));
        ...
        console.log(...oo_oo(`2894326370_285_4_285_79_4`, `##################################### DMS of ${user.id_user}`));
        console.log(...oo_oo(`2894326370_286_4_286_20_4`, dms));
        let recv;
        let send;
        let namerecv;
        let avatarrecv;
        ...
        if (dms) {
            ...
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`2894326370_301_8_301_30_4`, dmm.id_dm));
                recv = dmm.receiverId;
                send = dmm.senderId;
            ...
            console.log(...oo_oo(`2894326370_334_6_334_73_4`, "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ"));
            console.log(...oo_oo(`2894326370_335_6_335_29_4`, arrayOfDms));
            client.emit('response', arrayOfDms);
        }
    }
    async getAllMessages(client, data) {
        console.log(...oo_oo(`2894326370_353_4_353_48_4`, "*************   allMessagesDm"));
        const userId = Number(client.handshake.query.user_id);
        const user = await this.UsersService.findById(userId);
        console.log(...oo_oo(`2894326370_358_4_358_21_4`, data));
        if (user) {
            ...
            if (existDm) {
                ...
                console.log(...oo_oo(`2894326370_372_8_372_29_4`, messages));
                client.emit('historyDms', messages);
            }
        }
        else
            console.log(...oo_oo(`2894326370_381_6_381_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        console.log(...oo_oo(`2894326370_391_4_391_57_4`, "********************** allMessagesRoom"));
        console.log(...oo_oo(`2894326370_393_4_393_21_4`, data));
        ...
        if (user) {
            ...
            console.log(...oo_oo(`2894326370_408_6_408_46_4`, "Error user does not exist"));
    }
    async leavingRoom(client, data) {
        console.log(...oo_oo(`2894326370_415_4_415_51_4`, "********************** leaveRoom"));
        console.log(...oo_oo(`2894326370_417_4_417_21_4`, data));
        const user = await this.UsersService.findById(data.user_id);
        if (user) {
            const leave = await this.ChatService.getLeavingRoom(data.id, data.user_id);
            if (leave) {
                console.log(...oo_oo(`2894326370_425_8_425_83_4`, "User with ${data.user_id} is leaving room with id ${data.id}"));
                return true;
            }
        }
        else
            console.log(...oo_oo(`2894326370_430_6_430_46_4`, "Error user does not exist"));
    }
};
