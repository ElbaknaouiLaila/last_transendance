...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`2455303299_55_4_55_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`2455303299_57_5_57_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`2455303299_68_4_68_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`2455303299_70_5_70_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`2455303299_82_4_82_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`2455303299_86_4_86_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`2455303299_90_4_90_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`2455303299_132_6_132_57_4`, "*************   handling_joinRoom_dm"));
        this.joinRoom(senderClient, room);
        this.joinRoom(receiverClient, room);
        console.log(...oo_oo(`2455303299_138_6_138_37_4`, "starting sending"));
        console.log(...oo_oo(`2455303299_140_6_140_27_4`, senderId));
        console.log(...oo_oo(`2455303299_141_6_141_29_4`, receiverId));
        const dm = await this.ChatService.checkDm(senderId, receiverId);
        console.log(...oo_oo(`2455303299_147_6_147_54_4`, `FROM gatways value of Dm is ${dm}`));
        console.log(...oo_oo(`2455303299_149_6_149_72_4`, `^^^  SENDER IS ${senderId} REciver is ${receiverId}`));
        ...
        console.log(...oo_oo(`2455303299_164_6_164_71_4`, `¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤`));
        this.server.to(room).emit('chatToDm', data);
        console.log(...oo_oo(`2455303299_166_6_166_34_4`, "after sending"));
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`2455303299_183_4_183_49_4`, "*************   direct_message"));
    ...
    async handling_joinRoom_group(data, users) {
        console.log(...oo_oo(`2455303299_207_4_207_58_4`, "*************   handling_joinRoom_group"));
        const room = `room_${data.id}`;
        for (const user of users) {
            console.log(...oo_oo(`2455303299_214_6_214_45_4`, "Inside sockets of groups"));
            const client = this.connectedClients.get(user.userId);
            console.log(...oo_oo(`2455303299_216_6_216_53_4`, "11111111111111111111111111111111"));
            this.joinRoom(client, room);
            console.log(...oo_oo(`2455303299_218_6_218_59_4`, "22222222222222222222222222222222222222"));
        }
        ...
        console.log(...oo_oo(`2455303299_230_6_230_45_4`, "befoor emiting in groups"));
        this.server.to(room).emit('chatToGroup', result);
        console.log(...oo_oo(`2455303299_233_4_233_36_4`, "ENDING JOINGROUP "));
    }
    async sendInChannel(client, data) {
        console.log(...oo_oo(`2455303299_254_4_254_64_4`, "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"));
        console.log(...oo_oo(`2455303299_255_4_255_50_4`, "*************   channel_message"));
    ...
    async allConversationsDm(client, data) {
        console.log(...oo_oo(`2455303299_277_4_277_53_4`, "*************   allConversationsDm"));
        ...
        console.log(...oo_oo(`2455303299_287_4_287_79_4`, `##################################### DMS of ${user.id_user}`));
        console.log(...oo_oo(`2455303299_288_4_288_20_4`, dms));
        let recv;
        let send;
        let namerecv;
        let avatarrecv;
        ...
        if (dms) {
            ...
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`2455303299_303_8_303_30_4`, dmm.id_dm));
                recv = dmm.receiverId;
                send = dmm.senderId;
            ...
            console.log(...oo_oo(`2455303299_336_6_336_73_4`, "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ"));
            console.log(...oo_oo(`2455303299_337_6_337_29_4`, arrayOfDms));
            client.emit('response', arrayOfDms);
        }
    }
    async getAllMessages(client, data) {
        console.log(...oo_oo(`2455303299_355_4_355_48_4`, "*************   allMessagesDm"));
        const userId = Number(client.handshake.query.user_id);
        const user = await this.UsersService.findById(userId);
        console.log(...oo_oo(`2455303299_360_4_360_21_4`, data));
        if (user) {
            ...
            if (existDm) {
                ...
                console.log(...oo_oo(`2455303299_374_8_374_29_4`, messages));
                client.emit('historyDms', messages);
            }
        }
        else
            console.log(...oo_oo(`2455303299_383_6_383_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        console.log(...oo_oo(`2455303299_393_4_393_57_4`, "********************** allMessagesRoom"));
        console.log(...oo_oo(`2455303299_395_4_395_21_4`, data));
        ...
        if (user) {
            ...
            console.log(...oo_oo(`2455303299_410_6_410_46_4`, "Error user does not exist"));
    }
    async leavingRoom(client, data) {
        console.log(...oo_oo(`2455303299_417_4_417_51_4`, "********************** leaveRoom"));
        console.log(...oo_oo(`2455303299_419_4_419_21_4`, data));
        const user = await this.UsersService.findById(data.user_id);
        if (user) {
            const leave = await this.ChatService.getLeavingRoom(data.id, data.user_id);
            if (leave) {
                console.log(...oo_oo(`2455303299_427_8_427_83_4`, "User with ${data.user_id} is leaving room with id ${data.id}"));
                return true;
            }
        }
        else
            console.log(...oo_oo(`2455303299_432_6_432_46_4`, "Error user does not exist"));
    }
};
