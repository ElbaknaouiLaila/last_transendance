...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`49266869_54_4_54_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`49266869_56_5_56_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`49266869_66_4_66_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`49266869_68_5_68_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`49266869_80_4_80_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`49266869_84_4_84_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`49266869_88_4_88_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`49266869_133_6_133_37_4`, "starting sending"));
        const dm = await this.ChatService.checkDm(senderId, receiverId);
        console.log(...oo_oo(`49266869_139_6_139_54_4`, `FROM gatways value of Dm is ${dm}`));
        ...
        console.log(...oo_oo(`49266869_156_6_156_34_4`, "after sending"));
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`49266869_174_4_174_21_4`, data));
        room = this.createRoom(data.from, data.to);
        this.handling_joinRoom_dm(room, data.from, data.to, data.message);
        console.log(...oo_oo(`49266869_181_4_181_58_4`, `FRom websockets DM ==== ${data.message}`));
        console.log();
        console.log(...oo_oo(`49266869_183_4_183_51_4`, `client connected is ${client.id}`));
        return 'Hello world!';
    }
    ...
    async allConversationsDm(client, data) {
        ...
        console.log(...oo_oo(`49266869_253_4_253_53_4`, `Socket from allDms is ${client.id}`));
        const user = await this.UsersService.findById(userId);
        const dms = await this.ChatService.getAllConversations(user.id_user);
        console.log(...oo_oo(`49266869_259_4_259_44_4`, "|||||||||||||||||||||||||"));
        if (dms) {
            const arrayOfDms = [];
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`49266869_268_8_268_54_4`, `Last message is ${lastMsg.text}`));
                console.log(...oo_oo(`49266869_269_8_269_30_4`, dmm.id_dm));
                const newDm = {
                    id_room: dmm.id_dm,
                    id: dmm.receiverId,
            ...
            console.log(...oo_oo(`49266869_284_6_284_35_4`, "ZZZZZZZZZZZZZZ"));
            console.log(...oo_oo(`49266869_285_6_285_29_4`, arrayOfDms));
            client.emit('response', arrayOfDms);
        }
        console.log(...oo_oo(`49266869_295_4_295_34_4`, "after allconDms"));
    }
    async getAllMessages(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`49266869_309_6_309_45_4`, `messages are ${messages}`));
            client.emit('historyDms', messages);
            console.log(...oo_oo(`49266869_313_6_313_34_4`, "after sending"));
        }
        else
            console.log(...oo_oo(`49266869_316_6_316_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`49266869_334_6_334_34_4`, "after sending"));
        }
        else
            console.log(...oo_oo(`49266869_337_6_337_46_4`, "Error user does not exist"));
    }
};
