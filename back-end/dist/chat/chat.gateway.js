...
let ChatGateway = class ChatGateway {
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`3603001651_55_4_55_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`3603001651_57_5_57_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`3603001651_68_4_68_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`3603001651_70_5_70_48_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`3603001651_82_4_82_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`3603001651_86_4_86_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`3603001651_90_4_90_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`3603001651_135_6_135_37_4`, "starting sending"));
        const dm = await this.ChatService.checkDm(senderId, receiverId);
        console.log(...oo_oo(`3603001651_141_6_141_54_4`, `FROM gatways value of Dm is ${dm}`));
        ...
        console.log(...oo_oo(`3603001651_158_6_158_34_4`, "after sending"));
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`3603001651_176_4_176_21_4`, data));
        room = this.createRoom(data.from, data.to);
        this.handling_joinRoom_dm(room, data.from, data.to, data.message);
        console.log(...oo_oo(`3603001651_183_4_183_58_4`, `FRom websockets DM ==== ${data.message}`));
        console.log();
        console.log(...oo_oo(`3603001651_185_4_185_51_4`, `client connected is ${client.id}`));
        return 'Hello world!';
    }
    ...
    async sendInChannel(client, data) {
        console.log(...oo_oo(`3603001651_233_4_233_67_4`, "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"));
        console.log(...oo_oo(`3603001651_234_4_234_21_4`, data));
        const channel = await this.ChatService.findChannel(data.to);
        if (channel) {
            const users = await this.ChatService.getUsersInChannel(data.from);
    ...
    async allConversationsDm(client, data) {
        ...
        console.log(...oo_oo(`3603001651_257_4_257_53_4`, `Socket from allDms is ${client.id}`));
        const user = await this.UsersService.findById(userId);
        const dms = await this.ChatService.getAllConversations(user.id_user);
        console.log(...oo_oo(`3603001651_263_4_263_44_4`, "|||||||||||||||||||||||||"));
        if (dms) {
            const arrayOfDms = [];
            for (const dmm of dms) {
                ...
                console.log(...oo_oo(`3603001651_272_8_272_54_4`, `Last message is ${lastMsg.text}`));
                console.log(...oo_oo(`3603001651_273_8_273_30_4`, dmm.id_dm));
                const newDm = {
                    id_room: dmm.id_dm,
                    id: dmm.receiverId,
            ...
            console.log(...oo_oo(`3603001651_288_6_288_35_4`, "ZZZZZZZZZZZZZZ"));
            console.log(...oo_oo(`3603001651_289_6_289_29_4`, arrayOfDms));
            client.emit('response', arrayOfDms);
        }
        console.log(...oo_oo(`3603001651_299_4_299_34_4`, "after allconDms"));
    }
    async getAllMessages(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`3603001651_313_6_313_45_4`, `messages are ${messages}`));
            client.emit('historyDms', messages);
            console.log(...oo_oo(`3603001651_317_6_317_34_4`, "after sending"));
        }
        else
            console.log(...oo_oo(`3603001651_320_6_320_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`3603001651_338_6_338_34_4`, "after sending"));
        }
        else
            console.log(...oo_oo(`3603001651_341_6_341_46_4`, "Error user does not exist"));
    }
};
