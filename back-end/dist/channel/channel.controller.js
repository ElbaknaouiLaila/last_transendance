...
let ChannelsController = class ChannelsController {
    ...
    async create(req, data) {
        console.log(...oo_oo(`2279614874_33_4_33_54_4`, "------ Starting Creating a Channel "));
        console.log(...oo_oo(`2279614874_34_4_34_21_4`, data));
        console.log(...oo_oo(`2279614874_35_4_35_27_4`, data.title));
        console.log(...oo_oo(`2279614874_36_4_36_30_4`, data.password));
        console.log(...oo_oo(`2279614874_37_4_37_26_4`, data.type));
        console.log(...oo_oo(`2279614874_38_4_38_68_4`, `length of data.memebers is ${data.members.length}`));
        console.log(...oo_oo(`2279614874_39_4_39_32_4`, data.members[0]));
        console.log(...oo_oo(`2279614874_40_4_40_28_4`, req.cookies));
        console.log(...oo_oo(`2279614874_41_4_41_45_4`, "--------------------------"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        console.log(...oo_oo(`2279614874_45_4_45_23_4`, decode));
        console.log(...oo_oo(`2279614874_46_4_46_37_4`, `id is ${decode.id}`));
        console.log(...oo_oo(`2279614874_48_4_48_36_4`, "*****************"));
        const user = await this.UsersService.findById(decode.id);
        console.log(...oo_oo(`2279614874_50_4_50_37_4`, "##################"));
        const channel = await this.channelsService.createChannel(data, user.id_user);
        console.log(...oo_oo(`2279614874_53_4_53_45_4`, "End of Creating A Channel "));
        return true;
    }
    async join(req, data) {
        console.log(...oo_oo(`2279614874_64_4_64_53_4`, "------ Starting Joining a Channel "));
        console.log(...oo_oo(`2279614874_65_4_65_21_4`, data));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const name = "Assila";
        const memberChannel = await this.channelsService.joinChannel(data, user.id_user);
        console.log(...oo_oo(`2279614874_77_4_77_42_4`, "AFTER CREATEION        "));
        console.log(...oo_oo(`2279614874_78_6_78_32_4`, memberChannel));
    ...
    async removePass(req, data) {
        console.log(...oo_oo(`2279614874_97_4_97_29_4`, "removePass"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
    ...
    async muteUser(req, data) {
        console.log(...oo_oo(`2279614874_159_4_159_28_4`, "mutedUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async getAllChannels(req, data) {
        console.log(...oo_oo(`2279614874_191_4_191_31_4`, "all channels"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        ...
        if (myAllChannels) {
            ...
            for (const channels of myAllChannels) {
                ...
                console.log(...oo_oo(`2279614874_216_10_216_38_4`, "ADMINS ARE : "));
                console.log(...oo_oo(`2279614874_217_10_217_29_4`, admins));
                const memebers = await this.channelsService.getAllMembers(channels.channelId);
                console.log(...oo_oo(`2279614874_219_10_219_40_4`, "memebers ARE : "));
                console.log(...oo_oo(`2279614874_220_10_220_31_4`, memebers));
                const owners = await this.channelsService.getAllOwners(channels.channelId);
                console.log(...oo_oo(`2279614874_222_10_222_38_4`, "owners ARE : "));
                console.log(...oo_oo(`2279614874_223_10_223_29_4`, owners));
                const newCh = {
