...
let ChannelsController = class ChannelsController {
    ...
    async create(req, data) {
        console.log(...oo_oo(`3170901169_33_4_33_54_4`, "------ Starting Creating a Channel "));
        console.log(...oo_oo(`3170901169_34_4_34_21_4`, data));
        console.log(...oo_oo(`3170901169_35_4_35_27_4`, data.title));
        console.log(...oo_oo(`3170901169_36_4_36_30_4`, data.password));
        console.log(...oo_oo(`3170901169_37_4_37_26_4`, data.type));
        console.log(...oo_oo(`3170901169_38_4_38_68_4`, `length of data.memebers is ${data.members.length}`));
        console.log(...oo_oo(`3170901169_39_4_39_32_4`, data.members[0]));
        console.log(...oo_oo(`3170901169_40_4_40_28_4`, req.cookies));
        console.log(...oo_oo(`3170901169_41_4_41_45_4`, "--------------------------"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        console.log(...oo_oo(`3170901169_45_4_45_23_4`, decode));
        console.log(...oo_oo(`3170901169_46_4_46_37_4`, `id is ${decode.id}`));
        console.log(...oo_oo(`3170901169_48_4_48_36_4`, "*****************"));
        const user = await this.UsersService.findById(decode.id);
        console.log(...oo_oo(`3170901169_50_4_50_37_4`, "##################"));
        const channel = await this.channelsService.createChannel(data, user.id_user);
        console.log(...oo_oo(`3170901169_53_4_53_45_4`, "End of Creating A Channel "));
        return true;
    }
    async join(req, data) {
        console.log(...oo_oo(`3170901169_63_4_63_53_4`, "------ Starting Joining a Channel "));
        console.log(...oo_oo(`3170901169_64_4_64_26_4`, data.name));
        const decode = this.jwt.verify(req.cookies['cookie']);
        console.log(...oo_oo(`3170901169_67_4_67_23_4`, decode));
        console.log(...oo_oo(`3170901169_68_4_68_37_4`, `id is ${decode.id}`));
        console.log(...oo_oo(`3170901169_69_4_69_36_4`, "*****************"));
        const user = await this.UsersService.findById(decode.id);
        const name = "Assila";
    ...
    async removePass(req, data) {
        console.log(...oo_oo(`3170901169_94_4_94_29_4`, "removePass"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
    ...
    async kickUser(req, data) {
        console.log(...oo_oo(`3170901169_129_4_129_27_4`, "kickUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async banUser(req, data) {
        console.log(...oo_oo(`3170901169_142_4_142_29_4`, "bannedUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async muteUser(req, data) {
        console.log(...oo_oo(`3170901169_156_4_156_28_4`, "mutedUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async getAllChannels(req, data) {
        console.log(...oo_oo(`3170901169_187_4_187_31_4`, "all channels"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        console.log(...oo_oo(`3170901169_189_4_189_24_4`, "Reshe"));
        const user = await this.UsersService.findById(decode.id);
        const myAllChannels = await this.channelsService.getAllChannels(user.id_user);
        console.log(...oo_oo(`3170901169_197_4_197_33_4`, "START LOOPING "));
        let message = "";
        let sent = null;
        if (myAllChannels) {
            ...
            for (const channels of myAllChannels) {
                ...
                console.log(...oo_oo(`3170901169_213_10_213_38_4`, "ADMINS ARE : "));
                console.log(...oo_oo(`3170901169_214_10_214_29_4`, admins));
                const memebers = await this.channelsService.getAllMembers(channels.channelId);
                console.log(...oo_oo(`3170901169_216_10_216_40_4`, "memebers ARE : "));
                console.log(...oo_oo(`3170901169_217_10_217_31_4`, memebers));
                const owners = await this.channelsService.getAllOwners(channels.channelId);
                console.log(...oo_oo(`3170901169_219_10_219_38_4`, "owners ARE : "));
                console.log(...oo_oo(`3170901169_220_10_220_29_4`, owners));
                const newCh = {
            ...
            console.log(...oo_oo(`3170901169_235_8_235_79_4`, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"));
            console.log(...oo_oo(`3170901169_236_8_236_36_4`, arrayOfChannels));
            console.log(...oo_oo(`3170901169_237_8_237_93_4`, "ENNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNND"));
