...
let ChannelsController = class ChannelsController {
    ...
    async create(req, data) {
        console.log(...oo_oo(`2664841621_33_4_33_54_4`, "------ Starting Creating a Channel "));
        console.log(...oo_oo(`2664841621_34_4_34_21_4`, data));
        console.log(...oo_oo(`2664841621_35_4_35_27_4`, data.title));
        console.log(...oo_oo(`2664841621_36_4_36_30_4`, data.password));
        console.log(...oo_oo(`2664841621_37_4_37_26_4`, data.type));
        console.log(...oo_oo(`2664841621_38_4_38_68_4`, `length of data.memebers is ${data.members.length}`));
        console.log(...oo_oo(`2664841621_39_4_39_32_4`, data.members[0]));
        console.log(...oo_oo(`2664841621_40_4_40_28_4`, req.cookies));
        console.log(...oo_oo(`2664841621_41_4_41_45_4`, "--------------------------"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        console.log(...oo_oo(`2664841621_45_4_45_23_4`, decode));
        console.log(...oo_oo(`2664841621_46_4_46_37_4`, `id is ${decode.id}`));
        console.log(...oo_oo(`2664841621_48_4_48_36_4`, "*****************"));
        const user = await this.UsersService.findById(decode.id);
        console.log(...oo_oo(`2664841621_50_4_50_37_4`, "##################"));
        const channel = await this.channelsService.createChannel(data, user.id_user);
        console.log(...oo_oo(`2664841621_53_4_53_45_4`, "End of Creating A Channel "));
        return true;
    }
    async join(req, data) {
        console.log(...oo_oo(`2664841621_64_4_64_53_4`, "------ Starting Joining a Channel "));
        console.log(...oo_oo(`2664841621_65_4_65_21_4`, data));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const name = "Assila";
    ...
    async removePass(req, data) {
        console.log(...oo_oo(`2664841621_95_4_95_29_4`, "removePass"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
    ...
    async kickUser(req, data) {
        console.log(...oo_oo(`2664841621_130_4_130_27_4`, "kickUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async banUser(req, data) {
        console.log(...oo_oo(`2664841621_143_4_143_29_4`, "bannedUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async muteUser(req, data) {
        console.log(...oo_oo(`2664841621_157_4_157_28_4`, "mutedUser"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        const decode2 = this.jwt.verify(data.updated_user);
        const updatedUser = await this.UsersService.findById(decode2.id);
    ...
    async getAllChannels(req, data) {
        console.log(...oo_oo(`2664841621_189_4_189_31_4`, "all channels"));
        const decode = this.jwt.verify(req.cookies['cookie']);
        const user = await this.UsersService.findById(decode.id);
        ...
        if (myAllChannels) {
            ...
            for (const channels of myAllChannels) {
                ...
                console.log(...oo_oo(`2664841621_214_10_214_38_4`, "ADMINS ARE : "));
                console.log(...oo_oo(`2664841621_215_10_215_29_4`, admins));
                const memebers = await this.channelsService.getAllMembers(channels.channelId);
                console.log(...oo_oo(`2664841621_217_10_217_40_4`, "memebers ARE : "));
                console.log(...oo_oo(`2664841621_218_10_218_31_4`, memebers));
                const owners = await this.channelsService.getAllOwners(channels.channelId);
                console.log(...oo_oo(`2664841621_220_10_220_38_4`, "owners ARE : "));
                console.log(...oo_oo(`2664841621_221_10_221_29_4`, owners));
                const newCh = {
