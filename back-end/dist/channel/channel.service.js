...
let ChannelsService = class ChannelsService {
    ...
    async joinChannel(data, usid) {
        console.log(...oo_oo(`3526457529_164_4_164_44_4`, "join channel from service"));
        console.log(...oo_oo(`3526457529_165_4_165_21_4`, data));
        let join = 0;
        const ch = await this.getChannelByName(data.sendData.name);
        console.log(...oo_oo(`3526457529_169_4_169_41_4`, "//////////////////////"));
        console.log(...oo_oo(`3526457529_170_4_170_19_4`, ch));
        ...
        console.log(...oo_oo(`3526457529_183_4_183_22_4`, cheak));
        if (cheak) {
            console.log(...oo_oo(`3526457529_186_6_186_47_4`, "22222222222222222222222222"));
            throw new common_1.NotFoundException(`your not allowed to join this channel ${ch.name} cuz  you are banned`);
        }
        if (ch) {
            console.log(...oo_oo(`3526457529_192_6_192_53_4`, "heeeeeeeeeeeeeeeeey join channel"));
            if (ch.visibility === "protected") {
                console.log(...oo_oo(`3526457529_197_8_197_51_4`, `Protected channel ${ch.name}`));
                let test = await this.verifyPassword(data.sendData.password, ch.password);
                console.log(...oo_oo(`3526457529_199_8_199_38_4`, `Test is ${test}`));
                if (test) {
                    console.log(...oo_oo(`3526457529_202_9_202_85_4`, `cheaking password  ${data.sendData.password}  ${ch.password} `));
                    join = 1;
                }
            }
            if (join == 1 || ch.visibility === "public") {
                try {
                    console.log(...oo_oo(`3526457529_211_12_211_51_4`, "inside try joing channel"));
                    const memberchannel = await this.prisma.memberChannel.create({
                        data: {
                            userId: usid,
                            channelId: ch.id_channel,
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`3526457529_276_12_276_45_4`, "Yes I am the owner"));
                    if (ch.visibility == "protected") {
    ...
    async setPass(data, usid) {
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`3526457529_374_10_374_43_4`, "Yes I am the owner"));
                    if (ch.visibility == "public" || ch.visibility == "privat") {
                        console.log(...oo_oo(`3526457529_377_12_377_44_4`, "inside visibility"));
                        const updateChannel = await this.prisma.channel.update({
                            where: {
                                id_channel: ch.id_channel,
                            },
