...
let ChannelsService = class ChannelsService {
    ...
    async joinChannel(data, usid) {
        console.log(...oo_oo(`3518372804_162_4_162_44_4`, "join channel from service"));
        let join = 0;
        let pass = "lola123";
        const ch = await this.getChannelByName(data.name);
        console.log(...oo_oo(`3518372804_168_4_168_39_4`, "channel is " + ch.name));
        console.log(...oo_oo(`3518372804_169_4_169_45_4`, "channel is " + ch.visibility));
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`3518372804_265_12_265_45_4`, "Yes I am the owner"));
                    if (ch.visibility == "protected") {
    ...
    async setPass(data, usid) {
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`3518372804_363_10_363_43_4`, "Yes I am the owner"));
                    if (ch.visibility == "public" || ch.visibility == "privat") {
                        console.log(...oo_oo(`3518372804_366_12_366_44_4`, "inside visibility"));
                        const updateChannel = await this.prisma.channel.update({
                            where: {
                                id_channel: ch.id_channel,
                            },
