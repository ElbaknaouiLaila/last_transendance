...
let ChannelsService = class ChannelsService {
    ...
    async joinChannel(data, usid) {
        console.log(...oo_oo(`629942792_162_4_162_44_4`, "join channel from service"));
        console.log(...oo_oo(`629942792_163_4_163_21_4`, data));
        let join = 0;
        const ch = await this.getChannelByName(data.sendData.name);
        console.log(...oo_oo(`629942792_167_4_167_41_4`, "//////////////////////"));
        console.log(...oo_oo(`629942792_168_4_168_19_4`, ch));
        ...
        console.log(...oo_oo(`629942792_181_4_181_22_4`, cheak));
        if (cheak) {
            console.log(...oo_oo(`629942792_184_6_184_47_4`, "22222222222222222222222222"));
            throw new common_1.NotFoundException(`your not allowed to join this channel ${ch.name} cuz  you are banned`);
        }
        if (ch) {
            console.log(...oo_oo(`629942792_190_6_190_53_4`, "heeeeeeeeeeeeeeeeey join channel"));
            if (ch.visibility === "protected") {
                console.log(...oo_oo(`629942792_195_8_195_51_4`, `Protected channel ${ch.name}`));
                let test = await this.verifyPassword(data.sendData.password, ch.password);
                console.log(...oo_oo(`629942792_197_8_197_38_4`, `Test is ${test}`));
                if (test) {
                    console.log(...oo_oo(`629942792_200_9_200_85_4`, `cheaking password  ${data.sendData.password}  ${ch.password} `));
                    join = 1;
                }
            }
            if (join == 1 || ch.visibility === "public") {
                try {
                    console.log(...oo_oo(`629942792_209_12_209_51_4`, "inside try joing channel"));
                    const memberchannel = await this.prisma.memberChannel.create({
                        data: {
                            userId: usid,
                            channelId: ch.id_channel,
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`629942792_273_12_273_45_4`, "Yes I am the owner"));
                    if (ch.visibility == "protected") {
    ...
    async setPass(data, usid) {
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`629942792_371_10_371_43_4`, "Yes I am the owner"));
                    if (ch.visibility == "public" || ch.visibility == "privat") {
                        console.log(...oo_oo(`629942792_374_12_374_44_4`, "inside visibility"));
                        const updateChannel = await this.prisma.channel.update({
                            where: {
                                id_channel: ch.id_channel,
                            },
