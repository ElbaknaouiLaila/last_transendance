...
let ChannelsService = class ChannelsService {
    ...
    async joinChannel(data, usid) {
        console.log(...oo_oo(`2621163340_128_4_128_44_4`, "join channel from service"));
        let join = 0;
        let pass = "lola123";
        const ch = await this.getChannelByName(data.name);
        console.log(...oo_oo(`2621163340_134_4_134_39_4`, "channel is " + ch.name));
        console.log(...oo_oo(`2621163340_135_4_135_45_4`, "channel is " + ch.visibility));
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`2621163340_231_12_231_45_4`, "Yes I am the owner"));
                    if (ch.visibility == "protected") {
    ...
    async setPass(data, usid) {
        ...
        if (ch) {
            ...
            if (record) {
                if (record.status_UserInChannel == "owner") {
                    console.log(...oo_oo(`2621163340_329_10_329_43_4`, "Yes I am the owner"));
                    if (ch.visibility == "public" || ch.visibility == "privat") {
                        console.log(...oo_oo(`2621163340_332_12_332_44_4`, "inside visibility"));
                        const updateChannel = await this.prisma.channel.update({
                            where: {
                                id_channel: ch.id_channel,
                            },
